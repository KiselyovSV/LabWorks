    ...
    public class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            serviceProvider.GetRequiredService<DbContextOptions<FitnessDbContext>>()))
            {
                ...
                Workout wkt_1 = new() { Type = "Aqua Fitness", Description = "Силовая тренировка для продвинутых любителей аквафитнеса, направленная на укрепление мышц и снижение веса", IsActive = true };
                Workout wkt_2 = new() { Type = "TRX Blast", Description = "Функциональная тренировка с использованием специального оборудования ремней \"TRX\". Тренировка направлена на улучшение выносливости и сжигание лишних калорий", IsActive = true };
                Workout wkt_3 = new() { Type = "Make Body", Description = "Универсальная тренировка на снижение веса и укрепление всех основных мышечных групп", IsActive = true };
                Workout wkt_4 = new() { Type = "W Balance", Description = "Программа, сочетающая в себе базовые элементы Йоги, Тай-Чи, Пилатес. Контроль над дыханием, концентрация, гибкость и комплекс из силовых упражнений образуют целостную тренировочную систему, которая приведёт тело и разум в состояние равновесия.", IsActive = true };
                Workout wkt_5 = new() { Type = "ZUMBA", Description = "Простая для восприятия танцевальная тренировка под зажигательные латиноамериканские и мировые ритмы", IsActive = true };
                Workout wkt_6 = new() { Type = "Functional training", Description = "Функциональный тренинг – энергоемкое занятие, в основе которого многосуставные движения во всех плоскостях", IsActive = true };
                Workout wkt_7 = new() { Type = "Здоровая спина", Description = "Силовые упражнения для укрепления мышц спины и пресса, направленные на поддержание правильной осанки.Подходит для всех уровней подготовки.", IsActive = true };
